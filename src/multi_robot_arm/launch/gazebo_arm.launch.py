...
def generate_launch_description():
    ...
    robots = [
            {'name': 'arm1', 'x_pose': '-6.960770', 'y_pose': '3.659484', 'Y':'1.57' },
        ]
...
def spawn_robot(
    ...
    spawn_turtlebot_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('multi_robot_arm'), 'launch', 'spawn_serbot.launch.py')
        ),
        launch_arguments={
            'x_pose': x_pose,
            'y_pose': y_pose
    ...
    map_to_odom = Node(
        ...
        arguments=['2', '0.2', '0', '0', '0', '0', 'map', 'odom']
    )
